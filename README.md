...
`Unidad 1.` **Extracción de datos de diferentes fuentes**
   ...
   3. Extracción de datos de archivos XLS o XLSX
   4. Extracción de datos de archivos JSON
   5. Extracción de datos de archivos XML
   6. Extracción de datos de archivos SHP
   7. Extracción de datos de imágenes
